...
func init() {
	...
	password = ""
	host = "localhost"
	namaDB = "db_51418507" // Misal : db_13116429
	defaultDB = "mysql"
}
...
func initDatabase() (*sql.DB, error) {
	...
	if err = model.CreateTable(db, model.TabelMatakuliah); err != nil {
		fmt.Println("Gagal membuat table matakuliah")
		return nil, err
	}
	/*
